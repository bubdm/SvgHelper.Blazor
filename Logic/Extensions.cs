...
namespace SvgHelper.Blazor.Logic
{
    public static class Extensions
    {
        ...
        {
            //image.Width = "100%";
            //image.Height = "100%"; //you have to send the assembly
        ...
        public static void PopulateCircle(this Circle circle, float x, float y, float widthHeight, string customColor, double opacity = 1)
        {
            ...
            if (customColor != "")
            {
                circle.Fill = customColor.ToWebColor(); //provide different ways to populate.
                //to support gradients later.
            }
        ...
        public static Polygon CreatePolygon(this CustomBasicList<PointF> points)
        {
